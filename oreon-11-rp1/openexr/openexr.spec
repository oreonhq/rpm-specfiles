...
%global source0_sha256 0ffbd842a7ee2128d44affdea30f42294b4061293cde3aa75b61a53573413d1e
%global source0_file openexr-3.3.3.tar.gz
...
%(f=%{_sourcedir}/openexr-3.3.3.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "0ffbd842a7ee2128d44affdea30f42294b4061293cde3aa75b61a53573413d1e" || { echo "oreon: Source0 SHA256 mismatch for openexr-3.3.3.tar.gz" >&2; exit 1; })
