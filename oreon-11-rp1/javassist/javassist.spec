...
Source0:        https://github.com/jboss-%{name}/%{name}/archive/refs/tags/%{upstream_version}.tar.gz#/javassist-3.30.2.tar.gz
...
%setup -q -n javassist-rel_3_30_2_ga
%autosetup -p1 -n javassist-rel_3_30_2_ga
