...
URL: https://cgit.freedesktop.org/libreoffice/dictionaries/tree/br_FR
...
install -pm 0644 dictionaries/br_FR/br_FR.aff %{buildroot}%{_datadir}/%{dict_dirname}/
install -pm 0644 dictionaries/br_FR/br_FR.dic %{buildroot}%{_datadir}/%{dict_dirname}/
