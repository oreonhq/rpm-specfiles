...
Source0:        https://invent.kde.org/network/kio-ftps/-/archive/v%{version}/kio-ftps-v%{version}.tar.bz2#/kio-ftps-%{version}.tar.gz
...
%prep
_tar="kio-ftps-%{version}.tar.gz"
if test ! -f "$_tar"; then
  curl -sfL -o _src.rpm "https://mirrors.dotsrc.org/fedora/linux/development/rawhide/Everything/source/tree/Packages/k/kio-ftps-%{version}-34.fc44.src.rpm"
  rpm2cpio _src.rpm | cpio -id "$_tar"
  rm -f _src.rpm
fi
