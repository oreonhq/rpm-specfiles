...
# upstream ftp://ling.lll.hawaii.edu/pub/greg/gt-0.4.tar.gz is 404
# clean tarball drops examples/patch, sfz, and src/ac3* (patents / unclear license)
Source0:        gt-%{version}-clean.tar.gz
