...
%global source0_sha256 9fd1093b917a21fb79ae1607db53d113b4e0ad8fe0ae776cb077a7e50044fdf3
%global source0_file Data-OptList-0.114.tar.gz
...
%(f=%{_sourcedir}/Data-OptList-0.114.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "9fd1093b917a21fb79ae1607db53d113b4e0ad8fe0ae776cb077a7e50044fdf3" || { echo "oreon: Source0 SHA256 mismatch for Data-OptList-0.114.tar.gz" >&2; exit 1; })
