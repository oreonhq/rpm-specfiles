...
%global source1_sha256 a61d4e8b30f5a16526d7d31171b674ae7924d2207f378060d13363bd8794de8c
%global source1_file splitmix-0.1.3.2.tar.gz
...
%(f=%{_sourcedir}/splitmix-0.1.3.2.tar.gz; test -f "$f" || { echo "oreon: missing Source1 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "a61d4e8b30f5a16526d7d31171b674ae7924d2207f378060d13363bd8794de8c" || { echo "oreon: Source1 SHA256 mismatch for splitmix-0.1.3.2.tar.gz" >&2; exit 1; })
...
%changelog
* Tue Mar 17 2026 Oreon Packaging Team <packaging@oreonhq.com> - 1.2.1.3-7
