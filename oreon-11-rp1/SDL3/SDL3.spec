...
%global source0_sha256 082cbf5f429e0d80820f68dc2b507a94d4cc1b4e70817b119bbb8ec6a69584b8
%global source0_file SDL3-3.4.0.tar.gz
...
%(f=%{_sourcedir}/SDL3-3.4.0.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "082cbf5f429e0d80820f68dc2b507a94d4cc1b4e70817b119bbb8ec6a69584b8" || { echo "oreon: Source0 SHA256 mismatch for SDL3-3.4.0.tar.gz" >&2; exit 1; })
