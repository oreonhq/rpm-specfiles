...
%global source0_sha256 4401d4e231d842c2de8242395a74a395ca468cd96f5f610d822df33594898a70
%global source0_file desktop-file-utils-0.28.tar.xz
...
%(f=%{_sourcedir}/desktop-file-utils-0.28.tar.xz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "4401d4e231d842c2de8242395a74a395ca468cd96f5f610d822df33594898a70" || { echo "oreon: Source0 SHA256 mismatch for desktop-file-utils-0.28.tar.xz" >&2; exit 1; })
