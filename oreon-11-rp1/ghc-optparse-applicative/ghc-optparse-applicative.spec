...
%global source0_sha256 63811ab4fd26e829b8868364325a88be3acc79819f5bb5005b2dd3b961ecc491
%global source0_file optparse-applicative-0.18.1.0.tar.gz
...
%(f=%{_sourcedir}/optparse-applicative-0.18.1.0.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "63811ab4fd26e829b8868364325a88be3acc79819f5bb5005b2dd3b961ecc491" || { echo "oreon: Source0 SHA256 mismatch for optparse-applicative-0.18.1.0.tar.gz" >&2; exit 1; })
...
%changelog
* Tue Mar 17 2026 Oreon Packaging Team <packaging@oreonhq.com> - 0.18.1.0-1
