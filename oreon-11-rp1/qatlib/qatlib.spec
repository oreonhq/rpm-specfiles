...
Source0:        https://github.com/intel/%{name}/archive/%{version}/%{name}-%{version}.tar.gz#/qatlib-26.02.0.tar.gz
...
%changelog
* Mon May 25 2026 Oreon Packaging Team <packaging@oreonhq.com> - 26.02.0-2
- Import
