...
%global source0_sha256 99c56b395f1239af19901f2feeb125d9ecb4e351a0d80daa9529211a4700a6f2
%global source0_file Class-XSAccessor-1.19.tar.gz
...
%(f=%{_sourcedir}/Class-XSAccessor-1.19.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "99c56b395f1239af19901f2feeb125d9ecb4e351a0d80daa9529211a4700a6f2" || { echo "oreon: Source0 SHA256 mismatch for Class-XSAccessor-1.19.tar.gz" >&2; exit 1; })
