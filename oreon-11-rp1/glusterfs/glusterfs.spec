...
%if ( 0%{_for_fedora_koji_builds} )
Source0:        http://github.com/gluster/glusterfs/archive/v11.2%{?prereltag}/glusterfs-11.2%{?prereltag}.tar.gz
...
%changelog
* Tue Mar 17 2026 Oreon Packaging Team <packaging@oreonhq.com> - 11.2-5
