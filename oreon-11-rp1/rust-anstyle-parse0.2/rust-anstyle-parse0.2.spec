%global source0_hash 4e7644824f0aa2c7b9384579234ef10eb7efb6a0deb83f9630a49594dd9c15c2
...
%package     -n %{name}+utf8parse-devel
Summary:        %{summary}
BuildArch:      noarch

%description -n %{name}+utf8parse-devel %{_description}

This package contains library source intended for building other packages which
use the "utf8parse" feature of the "%{crate}" crate.

%files       -n %{name}+utf8parse-devel
%ghost %{crate_instdir}/Cargo.toml
