...
%global source0_sha256 1bdfb8f2dcb8da558d7210d7f21f054c4f0d934d69e86aed36675755ded370d5
%global source0_file kcompletion-6.24.0.tar.xz
...
%(f=%{_sourcedir}/kcompletion-6.24.0.tar.xz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "1bdfb8f2dcb8da558d7210d7f21f054c4f0d934d69e86aed36675755ded370d5" || { echo "oreon: Source0 SHA256 mismatch for kcompletion-6.24.0.tar.xz" >&2; exit 1; })
