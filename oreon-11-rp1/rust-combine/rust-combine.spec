%global source0_hash ba5a308b75df32fe02788e748662718f03fde005016435c444eea572398219fd
...
%package     -n %{name}+tokio-03-devel
Summary:        %{summary}
BuildArch:      noarch

%description -n %{name}+tokio-03-devel %{_description}

This package contains library source intended for building other packages which
use the "tokio-03" feature of the "%{crate}" crate.

%files       -n %{name}+tokio-03-devel
%ghost %{crate_instdir}/Cargo.toml

%package     -n %{name}+tokio-03-dep-devel
Summary:        %{summary}
BuildArch:      noarch

%description -n %{name}+tokio-03-dep-devel %{_description}

This package contains library source intended for building other packages which
use the "tokio-03-dep" feature of the "%{crate}" crate.

%files       -n %{name}+tokio-03-dep-devel
%ghost %{crate_instdir}/Cargo.toml
