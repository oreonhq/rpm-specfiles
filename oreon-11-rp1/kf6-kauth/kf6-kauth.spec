...
%global source0_sha256 f596667e272524b336f86dd81b9be487e3d75cbedcb2078293f51bb2ee6f384c
%global source0_file kauth-6.24.0.tar.xz
...
%(f=%{_sourcedir}/kauth-6.24.0.tar.xz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "f596667e272524b336f86dd81b9be487e3d75cbedcb2078293f51bb2ee6f384c" || { echo "oreon: Source0 SHA256 mismatch for kauth-6.24.0.tar.xz" >&2; exit 1; })
