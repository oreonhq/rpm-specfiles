...
Source0:        https://github.com/codehaus-plexus/plexus-utils/archive/refs/tags/plexus-utils-%{version}.tar.gz#/plexus-utils-%{version}.tar.gz
...
%setup -q -n plexus-utils-plexus-utils-3.5.1
%autosetup -p1 -n plexus-utils-plexus-utils-3.5.1
...
%changelog
* Tue Mar 17 2026 Oreon Packaging Team <packaging@oreonhq.com> - 3.5.1-1
