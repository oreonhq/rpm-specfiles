...
URL:            %{gourl}
Source0:        https://github.com/maxmind/geoipupdate/archive/v7.1.1/geoipupdate-7.1.1.tar.gz
# Generated by go-vendor-tools
Source1:        %{archivename}-vendor.tar.bz2
Source2:        go-vendor-tools.toml
Source3:        geoipupdate.cron
# oreon url source checksums begin
%global source0_sha256 f21b26d9be7281a0c90f9009ed150acb97e68e02be8a3e975315a7956de6965a
%global source0_file geoipupdate-7.1.1.tar.gz
...
%(f=%{_sourcedir}/geoipupdate-7.1.1.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "f21b26d9be7281a0c90f9009ed150acb97e68e02be8a3e975315a7956de6965a" || { echo "oreon: Source0 SHA256 mismatch for geoipupdate-7.1.1.tar.gz" >&2; exit 1; })
