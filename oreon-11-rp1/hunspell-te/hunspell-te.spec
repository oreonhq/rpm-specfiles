...
URL: https://cgit.freedesktop.org/libreoffice/dictionaries/tree/te_IN
...
install -pm 0644 dictionaries/te_IN/te_IN.aff %{buildroot}%{_datadir}/%{dict_dirname}/
install -pm 0644 dictionaries/te_IN/te_IN.dic %{buildroot}%{_datadir}/%{dict_dirname}/


%files
%doc dictionaries/te_IN/README_te_IN.txt
