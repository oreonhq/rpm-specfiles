...
%global source0_sha256 9759f4e158d1f466030131443201441b2f7cff12638a24f6184bdae4b08e2a05
%global source0_file knewstuff-6.24.0.tar.xz
...
%(f=%{_sourcedir}/knewstuff-6.24.0.tar.xz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "9759f4e158d1f466030131443201441b2f7cff12638a24f6184bdae4b08e2a05" || { echo "oreon: Source0 SHA256 mismatch for knewstuff-6.24.0.tar.xz" >&2; exit 1; })
