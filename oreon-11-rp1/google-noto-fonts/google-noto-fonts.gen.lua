...
-- Install lists are written in %%prep under %%{_builddir} (colon to newlines) so %%install always
-- finds them. Parse-time writes next to the spec were flaky on some workers (%%{_specdir} vs mock).
