%global source0_hash a289434347cc96054c75d1e4e4408b84adc2e8c7862f0be4e2da8fafbf26bf26
...
Source0:        https://download.kde.org/stable/oxygen-gtk2/%{version}/src/%{name}-%{version}.tar.bz2
