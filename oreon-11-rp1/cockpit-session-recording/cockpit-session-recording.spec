...
%global source0_sha256 b90e96aa904c0a7d00eb1988d5a34a85b69f0bfb3cc322891ef64207f1173b1f
%global source0_file cockpit-session-recording-20.tar.xz
...
%(f=%{_sourcedir}/cockpit-session-recording-20.tar.xz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "b90e96aa904c0a7d00eb1988d5a34a85b69f0bfb3cc322891ef64207f1173b1f" || { echo "oreon: Source0 SHA256 mismatch for cockpit-session-recording-20.tar.xz" >&2; exit 1; })
