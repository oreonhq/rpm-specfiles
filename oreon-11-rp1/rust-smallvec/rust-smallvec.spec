%global source0_hash 8ed6a63f02c8539c91a8685a86f4099661ba3da017932f6ebbea6de3f0fa7c90
...
Version:        1.15.2
Release:        %autorelease
Summary:        'Small vector' optimization: store up to a small number of items on
...
'Small vector' optimization: store up to a small number of items on
the stack.}
...
%package     -n %{name}+impl_bincode-devel
Summary:        %{summary}
BuildArch:      noarch

%description -n %{name}+impl_bincode-devel %{_description}

This package contains library source intended for building other packages which
use the "impl_bincode" feature of the "%{crate}" crate.

%files       -n %{name}+impl_bincode-devel
%ghost %{crate_instdir}/Cargo.toml
