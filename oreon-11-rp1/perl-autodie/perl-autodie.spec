...
%global source0_sha256 4921d211b0cea63c2ca06dfc0c948a7203a3d48ad80a06f43b46104354f2c1c3
%global source0_file autodie-2.37.tar.gz
...
%(f=%{_sourcedir}/autodie-2.37.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "4921d211b0cea63c2ca06dfc0c948a7203a3d48ad80a06f43b46104354f2c1c3" || { echo "oreon: Source0 SHA256 mismatch for autodie-2.37.tar.gz" >&2; exit 1; })
