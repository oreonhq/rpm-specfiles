...
Source0:        https://download.kde.org/stable/plasma/%{version}/plasma5support-%{version}.tar.xz
# oreon url source checksums begin
%global source0_sha256 7f764826ef8967990eb42da3636bbfdd29c85e3928eeb917b8d8fed4b77f730c
%global source0_file plasma5support-6.6.3.tar.xz
...
%(f=%{_sourcedir}/plasma5support-6.6.3.tar.xz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "7f764826ef8967990eb42da3636bbfdd29c85e3928eeb917b8d8fed4b77f730c" || { echo "oreon: Source0 SHA256 mismatch for plasma5support-6.6.3.tar.xz" >&2; exit 1; })
