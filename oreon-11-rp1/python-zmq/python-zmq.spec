%global source0_hash 4fd229c1c7b10e2b578778a8919694186731c69dcb26e9c33239bee67a4dc0be
...
%build
%pyproject_wheel -Ccmake.define.PYZMQ_LIBZMQ_RPATH:BOOL=OFF -Ccmake.define.PYZMQ_NO_BUNDLE=ON -Clogging.level=INFO -Cbuild.verbose=true -Ccmake.build-type="RelWithDebInfo"
