...
%global source0_sha256 df31d8efec775124dab856d7177ddcba31be9f9e0836ebdab03d94392f2dd453
%global source0_file HTTP-4000.4.1.tar.gz
...
%(f=%{_sourcedir}/HTTP-4000.4.1.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "df31d8efec775124dab856d7177ddcba31be9f9e0836ebdab03d94392f2dd453" || { echo "oreon: Source0 SHA256 mismatch for HTTP-4000.4.1.tar.gz" >&2; exit 1; })
...
%changelog
* Tue Mar 17 2026 Oreon Packaging Team <packaging@oreonhq.com> - 4000.4.1-1
