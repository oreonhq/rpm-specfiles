...
URL:            %{gourl}
Source0:        https://github.com/redhatinsights/yggdrasil/archive/v0.4.9/yggdrasil-0.4.9.tar.gz
# Generated by go-vendor-tools
Source1:        %{archivename}-vendor.tar.bz2
Source2:        go-vendor-tools.toml
Source3:        yggdrasil.sysusers
# oreon url source checksums begin
%global source0_sha256 7c5ff02af7fae52e190819d4d440f9afe2c94c29a2d613211e9e0ae250c70d0a
%global source0_file yggdrasil-0.4.9.tar.gz
...
%(f=%{_sourcedir}/yggdrasil-0.4.9.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "7c5ff02af7fae52e190819d4d440f9afe2c94c29a2d613211e9e0ae250c70d0a" || { echo "oreon: Source0 SHA256 mismatch for yggdrasil-0.4.9.tar.gz" >&2; exit 1; })
...
%changelog
* Mon May 25 2026 Oreon Packaging Team <packaging@oreonhq.com> - 0.4.9-1
- Import
