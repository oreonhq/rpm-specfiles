...
URL:            %{gourl}
Source0:        https://github.com/redhatinsights/yggdrasil/archive/refs/tags/v%{version}.tar.gz#/yggdrasil-%{version}.tar.gz
# Generated by go-vendor-tools
Source1:        go-vendor-tools.toml
Source2:        yggdrasil.sysusers
...
install -D -m 0644 %{SOURCE2} %{buildroot}%{_sysusersdir}/yggdrasil.conf
%go_vendor_license_install -c %{SOURCE1}
