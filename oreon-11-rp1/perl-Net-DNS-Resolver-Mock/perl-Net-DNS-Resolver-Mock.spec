...
%global source0_sha256 ed4930577fd1a29d6435b5875533d3b28f5c1258a35833fe6ca2cb6a2685a49b
%global source0_file Net-DNS-Resolver-Mock-1.20230216.tar.gz
...
%(f=%{_sourcedir}/Net-DNS-Resolver-Mock-1.20230216.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "ed4930577fd1a29d6435b5875533d3b28f5c1258a35833fe6ca2cb6a2685a49b" || { echo "oreon: Source0 SHA256 mismatch for Net-DNS-Resolver-Mock-1.20230216.tar.gz" >&2; exit 1; })
