%global source0_hash 3f0113cf8fe71dc7484636dc8e2a581637ecbcc82d0be29bbd46d0bf3f8cdb37
...
Provides:       perl(Text::BibTeX)
Provides:       perl(Text::BibTeX::Name)
Provides:       perl(Text::BibTeX::NameFormat)
%description
