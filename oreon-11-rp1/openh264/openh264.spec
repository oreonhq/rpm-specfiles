...
Source0:        https://github.com/cisco/openh264/archive/refs/tags/v%{version}.tar.gz#/openh264-%{version}.tar.gz
Source1:        https://github.com/mozilla/gmp-api/archive/refs/tags/%{commit1}.tar.gz#/gmp-api-%{shortcommit1}.tar.gz
