...
%global source3_key_fpr 872F3A8A0B84905AFFBC8766FF9868A2D488A5A9
...
%if %{with signed}
Source2:        weldr-client-%{version}.tar.gz.asc
Source3:        gpg-872F3A8A0B84905AFFBC8766FF9868A2D488A5A9.key
%endif
