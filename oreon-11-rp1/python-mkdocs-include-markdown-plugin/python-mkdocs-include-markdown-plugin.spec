...
Source:         %{pypi_source mkdocs_include_markdown_plugin}
...
This is package 'mkdocs-include-markdown-plugin' generated automatically by pyp2spec.}
...
%prep
%autosetup -p1 -n mkdocs_include_markdown_plugin-%{version}
