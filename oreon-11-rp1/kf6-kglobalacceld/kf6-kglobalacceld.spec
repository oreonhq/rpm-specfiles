%global source0_hash ff5e36dcbcb8182f1b695062993a9ea2cc73d267536b2f5926de039fa7732c65
...
Source0:        https://download.kde.org/%{stable_kf6}/plasma/%{version}/kglobalacceld-%{version}.tar.xz#/%{name}-%{version}.tar.xz
