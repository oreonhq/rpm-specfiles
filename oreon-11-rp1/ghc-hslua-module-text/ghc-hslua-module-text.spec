...
%global source0_sha256 cb90b08c45e9aa0f2af61adb0b77fe8843999a514fcdda72b13c2aabda2cc398
%global source0_file hslua-module-text-1.1.1.tar.gz
...
%(f=%{_sourcedir}/hslua-module-text-1.1.1.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "cb90b08c45e9aa0f2af61adb0b77fe8843999a514fcdda72b13c2aabda2cc398" || { echo "oreon: Source0 SHA256 mismatch for hslua-module-text-1.1.1.tar.gz" >&2; exit 1; })
