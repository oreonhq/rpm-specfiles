...
%global source0_sha256 7c386a8aaaa3aece727eec3e1a51217a97f4af36cca28c8ea2fb2280b09edd6e
%global source0_file kronosnet-1.33.tar.xz
...
%(f=%{_sourcedir}/kronosnet-1.33.tar.xz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "7c386a8aaaa3aece727eec3e1a51217a97f4af36cca28c8ea2fb2280b09edd6e" || { echo "oreon: Source0 SHA256 mismatch for kronosnet-1.33.tar.xz" >&2; exit 1; })
