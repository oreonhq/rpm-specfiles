%global source0_hash c362e35ee973fa7be58cc5e38a4a6c23cc8f7e652555daf4f115a9eb2d3a6be7
...
Source0:        https://github.com/nmoinvaz/%{name}/archive/refs/tags/%{version}/%{name}-%{version}.tar.gz
