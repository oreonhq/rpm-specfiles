...
%global source0_sha256 f5286492b901a6f4333f4515a64fd7b1b1a2ee632b352db800dedccf249d424e
%global source0_file hspec-core-2.11.16.tar.gz
...
%(f=%{_sourcedir}/hspec-core-2.11.16.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "f5286492b901a6f4333f4515a64fd7b1b1a2ee632b352db800dedccf249d424e" || { echo "oreon: Source0 SHA256 mismatch for hspec-core-2.11.16.tar.gz" >&2; exit 1; })
