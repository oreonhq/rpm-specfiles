...
%global source0_sha256 8fe65cfc0261ed3c8a4395f0524286f5719669fe305f9b03b16cf3684d62cd70
%global source0_file Test-Harness-3.52.tar.gz
...
%(f=%{_sourcedir}/Test-Harness-3.52.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "8fe65cfc0261ed3c8a4395f0524286f5719669fe305f9b03b16cf3684d62cd70" || { echo "oreon: Source0 SHA256 mismatch for Test-Harness-3.52.tar.gz" >&2; exit 1; })
