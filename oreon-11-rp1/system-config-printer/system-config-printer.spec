...
Source0:        https://github.com/OpenPrinting/system-config-printer/archive/refs/tags/v1.5.18/system-config-printer-1.5.18.tar.gz#/system-config-printer-%{version}.tar.xz
