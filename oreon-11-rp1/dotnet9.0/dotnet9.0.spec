...
Source3:        https://github.com/dotnet/dotnet/releases/download/%{upstream_tag}/dotnet-prebuilts-%{bootstrap_sdk_version_ppc64le_s390x}-s390x.tar.gz
%endif
