...
%global source0_sha256 b074c239ee828fcb9c97774b942f3ce51f0d2edc00809f49c3c3ef0f3baaf9c1
%global source0_file release_v2.22.tar.gz
...
%(f=%{_sourcedir}/release_v2.22.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "b074c239ee828fcb9c97774b942f3ce51f0d2edc00809f49c3c3ef0f3baaf9c1" || { echo "oreon: Source0 SHA256 mismatch for release_v2.22.tar.gz" >&2; exit 1; })
