...
%global source0_sha256 2c81fea42bbe79ec488774043c1ec54f30efba059df9a4f3681ce83d85007f01
%global source0_file safe-0.3.21.tar.gz
...
%(f=%{_sourcedir}/safe-0.3.21.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "2c81fea42bbe79ec488774043c1ec54f30efba059df9a4f3681ce83d85007f01" || { echo "oreon: Source0 SHA256 mismatch for safe-0.3.21.tar.gz" >&2; exit 1; })
...
%changelog
* Tue Mar 17 2026 Oreon Packaging Team <packaging@oreonhq.com> - 0.3.21-1
