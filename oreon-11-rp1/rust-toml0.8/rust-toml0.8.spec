%global source0_hash dc1beb996b9d83529a9e75c17a1686767d148d70663143c7854d8b4a09ced362
...
%package     -n %{name}+toml_edit-devel
Summary:        %{summary}
BuildArch:      noarch

%description -n %{name}+toml_edit-devel %{_description}

This package contains library source intended for building other packages which
use the "toml_edit" feature of the "%{crate}" crate.

%files       -n %{name}+toml_edit-devel
%ghost %{crate_instdir}/Cargo.toml
