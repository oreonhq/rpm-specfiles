...
URL: https://cgit.freedesktop.org/libreoffice/dictionaries/tree/vi
...
install -pm 0644 dictionaries/vi/vi_VN.aff %{buildroot}%{_datadir}/%{dict_dirname}/
install -pm 0644 dictionaries/vi/vi_VN.dic %{buildroot}%{_datadir}/%{dict_dirname}/
