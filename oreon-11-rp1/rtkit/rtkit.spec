%global source0_hash bd6c1a236e479c59658b1e7be072e5990ad97439a2ecac433b0edfeb2531b52c
...
%prep
test "%{source0_hash}" = "none" || { f="%{SOURCE0}"; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "%{source0_hash}" || { echo "oreon: Source0 hash mismatch" >&2; exit 1; }; }# GitLab archive unpacks to rtkit-v%%{version}, not rtkit-%%{version}
...
%changelog
* Tue Mar 17 2026 Oreon Packaging Team <packaging@oreonhq.com> - 0.14-1
