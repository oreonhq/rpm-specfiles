...
%global source0_file Pod-Coverage-TrustPod-0.100006.tar.gz
...
%(f=%{_sourcedir}/Pod-Coverage-TrustPod-0.100006.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "358adc2504f039eb69098aa99bdde6ae9dc935364a8e144f6405e8293b3a7ca3" || { echo "oreon: Source0 SHA256 mismatch for Pod-Coverage-TrustPod-0.100006.tar.gz" >&2; exit 1; })
