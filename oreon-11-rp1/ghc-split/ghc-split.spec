...
%global source0_sha256 52da404e8397c1ab238354c8d4fd9a7e9c5cac8849cc2ce2e45facc85e74a913
%global source0_file split-0.2.5.tar.gz
...
%(f=%{_sourcedir}/split-0.2.5.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "52da404e8397c1ab238354c8d4fd9a7e9c5cac8849cc2ce2e45facc85e74a913" || { echo "oreon: Source0 SHA256 mismatch for split-0.2.5.tar.gz" >&2; exit 1; })
