...
%global source0_file libnotify-0.8.8.tar.xz
...
%(f=%{_sourcedir}/libnotify-0.8.8.tar.xz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "23420ef619dc2cb5aebad613f4823a2fa41c07e5a1d05628d40f6ec4b35bfddd" || { echo "oreon: Source0 SHA256 mismatch for libnotify-0.8.8.tar.xz" >&2; exit 1; })
