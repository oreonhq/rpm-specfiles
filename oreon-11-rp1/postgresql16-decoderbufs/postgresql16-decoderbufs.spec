...
Source0:        https://github.com/debezium/%{majorname}/archive/refs/tags/v%{full_version}.tar.gz#/postgresql16-decoderbufs-3.2.0.tar.gz
...
%changelog
* Mon May 25 2026 Oreon Packaging Team <packaging@oreonhq.com> - 3.2.0-3.Final
- Import
