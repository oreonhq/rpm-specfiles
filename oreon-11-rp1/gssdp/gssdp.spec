...
%global source0_sha256 ff97fdfb7f561d3e6813b4f6a2145259e7c2eff43cc0e63f3fd031d0b6266032
%global source0_file gssdp-1.6.4.tar.xz
...
%(f=%{_sourcedir}/gssdp-1.6.4.tar.xz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "ff97fdfb7f561d3e6813b4f6a2145259e7c2eff43cc0e63f3fd031d0b6266032" || { echo "oreon: Source0 SHA256 mismatch for gssdp-1.6.4.tar.xz" >&2; exit 1; })
