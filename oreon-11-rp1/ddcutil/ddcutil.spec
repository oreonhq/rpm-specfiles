...
Source0:        https://github.com/rockowitz/ddcutil/archive/refs/tags/v%{version}.tar.gz#/%{name}-%{version}.tar.gz
...
%changelog
* Sat Apr 18 2026 Oreon Packaging Team <packaging@oreonhq.com> - 2.2.1-1
- Import from Fedora 43 dist-git for Oreon 11 (RP1), replace autorelease and autochangelog
