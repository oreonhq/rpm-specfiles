...
%global source0_sha256 ac2ac757f5942d318a311a54b0c80b5ef295f299c2a73c632f6bfb1ff49cc6da
%global source0_file gtk+-2.24.33.tar.xz
...
%(f=%{_sourcedir}/gtk+-2.24.33.tar.xz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "ac2ac757f5942d318a311a54b0c80b5ef295f299c2a73c632f6bfb1ff49cc6da" || { echo "oreon: Source0 SHA256 mismatch for gtk+-2.24.33.tar.xz" >&2; exit 1; })
