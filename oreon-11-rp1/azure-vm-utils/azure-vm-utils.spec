...
%global source0_sha256 86f74ab16363a8d65cb37d4b25735570105307479002b990f4365bd2a15efdd9
%global source0_file azure-vm-utils-v0.7.0.tar.gz
...
%(f=%{_sourcedir}/azure-vm-utils-v0.7.0.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "86f74ab16363a8d65cb37d4b25735570105307479002b990f4365bd2a15efdd9" || { echo "oreon: Source0 SHA256 mismatch for azure-vm-utils-v0.7.0.tar.gz" >&2; exit 1; })
