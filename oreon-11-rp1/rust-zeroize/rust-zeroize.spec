%global source0_hash e13c156562582aa81c60cb29407084cdb54c4164760106ab78e6c5b0858cf64e
...
Version:        1.9.0
Release:        %autorelease
Summary:        Securely clear secrets from memory with a simple trait built on
...
Rust primitives which guarantee memory is zeroed using an operation
will not be 'optimized away' by the compiler. Uses a portable pure
Rust implementation that works everywhere, even WASM!.}
