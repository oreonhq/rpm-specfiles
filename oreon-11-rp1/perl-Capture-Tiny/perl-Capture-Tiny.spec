...
%global source0_file Capture-Tiny-0.50.tar.gz
...
%(f=%{_sourcedir}/Capture-Tiny-0.50.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "ca6e8d7ce7471c2be54e1009f64c367d7ee233a2894cacf52ebe6f53b04e81e5" || { echo "oreon: Source0 SHA256 mismatch for Capture-Tiny-0.50.tar.gz" >&2; exit 1; })
