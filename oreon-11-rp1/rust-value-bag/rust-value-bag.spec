%global source0_hash ef73bfbaf3216cb59c205d7176bee1194e0d84348979da31f4a71fefe3c2054e
...
%package     -n %{name}+inline-str-l-devel
Summary:        %{summary}
BuildArch:      noarch

%description -n %{name}+inline-str-l-devel %{_description}

This package contains library source intended for building other packages which
use the "inline-str-l" feature of the "%{crate}" crate.

%files       -n %{name}+inline-str-l-devel
%ghost %{crate_instdir}/Cargo.toml
