...
%global source0_file kstars-3.8.0.tar.xz
...
%(f=%{_sourcedir}/kstars-3.8.0.tar.xz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "9e907499a6087406601c1559a90f6551ef557ef4642371355929c6ed12188dee" || { echo "oreon: Source0 SHA256 mismatch for kstars-3.8.0.tar.xz" >&2; exit 1; })
