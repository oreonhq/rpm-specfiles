...
URL: https://cgit.freedesktop.org/libreoffice/dictionaries/tree/sw_TZ
...
install -pm 0644 dictionaries/sw_TZ/sw_TZ.aff %{buildroot}%{_datadir}/%{dict_dirname}/
install -pm 0644 dictionaries/sw_TZ/sw_TZ.dic %{buildroot}%{_datadir}/%{dict_dirname}/
