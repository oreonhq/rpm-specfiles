...
%global source0_sha256 7ad887792e37cc3ffd64681a3e7483c5f789b44a033f340bc771e45832ebff32
%global source0_file IO-Zlib-1.15.tar.gz
...
%(f=%{_sourcedir}/IO-Zlib-1.15.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "7ad887792e37cc3ffd64681a3e7483c5f789b44a033f340bc771e45832ebff32" || { echo "oreon: Source0 SHA256 mismatch for IO-Zlib-1.15.tar.gz" >&2; exit 1; })
