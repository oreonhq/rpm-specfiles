%global source0_hash 95188d847aa13eb69fcd8169f16d25b5c427d010b7e6daa5bbea34ecde34e46a
...
Source0:        https://github.com/power-ras/%{name}/archive/v%{version}/%{name}-%{version}.tar.gz#/servicelog-1.1.16.tar.gz
