...
Source0:        https://download.kde.org/%{stable_kf6}/plasma/6.6.5/plasma-thunderbolt-6.6.5.tar.xz
Source1:        https://download.kde.org/%{stable_kf6}/plasma/6.6.5/plasma-thunderbolt-6.6.5.tar.xz.sig
