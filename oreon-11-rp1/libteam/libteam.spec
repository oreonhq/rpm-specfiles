...
%global source0_sha256 a0a0fbf75423cbb835c2fc667e861090c925f9899f162b1d1f893b75c0ad5cfe
%global source0_file libteam-1.32.tar.gz
...
%(f=%{_sourcedir}/libteam-1.32.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "a0a0fbf75423cbb835c2fc667e861090c925f9899f162b1d1f893b75c0ad5cfe" || { echo "oreon: Source0 SHA256 mismatch for libteam-1.32.tar.gz" >&2; exit 1; })
