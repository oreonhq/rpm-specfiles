...
%global source0_sha256 d3e267753eb64c3bbba8e4af4a4503695ee62d015b30c2dad1a1f1343890fea4
%global source0_file kpeople-6.24.0.tar.xz
...
%(f=%{_sourcedir}/kpeople-6.24.0.tar.xz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "d3e267753eb64c3bbba8e4af4a4503695ee62d015b30c2dad1a1f1343890fea4" || { echo "oreon: Source0 SHA256 mismatch for kpeople-6.24.0.tar.xz" >&2; exit 1; })
