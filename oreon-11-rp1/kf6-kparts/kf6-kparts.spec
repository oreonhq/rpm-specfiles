...
%global source0_sha256 b4a0b72167e0f77974aafe93305c18dcc99c0e66c1f2fd56a3e44d78e72f54e7
%global source0_file kparts-6.24.0.tar.xz
...
%(f=%{_sourcedir}/kparts-6.24.0.tar.xz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "b4a0b72167e0f77974aafe93305c18dcc99c0e66c1f2fd56a3e44d78e72f54e7" || { echo "oreon: Source0 SHA256 mismatch for kparts-6.24.0.tar.xz" >&2; exit 1; })
