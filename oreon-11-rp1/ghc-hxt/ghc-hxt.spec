...
%global source0_sha256 ef602fe674225527750574dd555dbdf402ab77d054af75d41ca21b42dbb23ad9
%global source0_file hxt-9.3.1.22.tar.gz
...
%(f=%{_sourcedir}/hxt-9.3.1.22.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "ef602fe674225527750574dd555dbdf402ab77d054af75d41ca21b42dbb23ad9" || { echo "oreon: Source0 SHA256 mismatch for hxt-9.3.1.22.tar.gz" >&2; exit 1; })
...
%changelog
* Tue Mar 17 2026 Oreon Packaging Team <packaging@oreonhq.com> - 9.3.1.22-1
