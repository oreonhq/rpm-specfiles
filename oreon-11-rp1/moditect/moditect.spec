...
%global source0_file moditect-1.1.0.tar.gz
...
%(f=%{_sourcedir}/moditect-1.1.0.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "02d186e71967646803b9316b17ce7ac5a858a4690f4afe9e4af2a2f9e73b2bb3" || { echo "oreon: Source0 SHA256 mismatch for moditect-1.1.0.tar.gz" >&2; exit 1; })
