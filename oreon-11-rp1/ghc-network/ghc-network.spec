...
%global source0_sha256 51788e5eeb7d77264f260acd48df8055a4dbc2477e8d634a8493677bb15c5fc8
%global source0_file network-3.2.8.0.tar.gz
...
%(f=%{_sourcedir}/network-3.2.8.0.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "51788e5eeb7d77264f260acd48df8055a4dbc2477e8d634a8493677bb15c5fc8" || { echo "oreon: Source0 SHA256 mismatch for network-3.2.8.0.tar.gz" >&2; exit 1; })
...
%changelog
* Tue Mar 17 2026 Oreon Packaging Team <packaging@oreonhq.com> - 3.2.8.0-1
