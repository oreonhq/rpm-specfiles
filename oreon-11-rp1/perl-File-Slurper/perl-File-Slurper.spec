...
%global source0_sha256 d5a36487339888c3cd758e648160ee1d70eb4153cacbaff57846dbcefb344b0c
%global source0_file File-Slurper-0.014.tar.gz
...
%(f=%{_sourcedir}/File-Slurper-0.014.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "d5a36487339888c3cd758e648160ee1d70eb4153cacbaff57846dbcefb344b0c" || { echo "oreon: Source0 SHA256 mismatch for File-Slurper-0.014.tar.gz" >&2; exit 1; })
