...
Source0:        https://download.kde.org/%{stable_kf6}/plasma/6.6.3/kactivitymanagerd-6.6.3.tar.xz
Source1:        https://download.kde.org/%{stable_kf6}/plasma/6.6.3/kactivitymanagerd-6.6.3.tar.xz.sig
