...
%global source0_file Storable-3.25.tar.gz
...
%(f=%{_sourcedir}/Storable-3.25.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "e1e96b24a076792fde52154789fe4b76034b9ad39c8a1a819ead77d50d5f1817" || { echo "oreon: Source0 SHA256 mismatch for Storable-3.25.tar.gz" >&2; exit 1; })
