...
%global source0_sha256 0ef0e52b8a9cd932855379197dd8f94047b359ca0a78695144304cb45f87c9eb
%global source0_file flask-3.1.3.tar.gz
...
%(f=%{_sourcedir}/flask-3.1.3.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "0ef0e52b8a9cd932855379197dd8f94047b359ca0a78695144304cb45f87c9eb" || { echo "oreon: Source0 SHA256 mismatch for flask-3.1.3.tar.gz" >&2; exit 1; })
