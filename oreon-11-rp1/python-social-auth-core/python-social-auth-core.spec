...
Source:         %{pypi_source social_auth_core}
...
%pyproject_extras_subpkg -n python3-social-auth-core all,allpy3,dev,google-onetap,saml,shopify


%prep
%autosetup -p1 -n social_auth_core-%{version}


%generate_buildrequires
# Keep only those extras which you actually want to package or use during tests
%pyproject_buildrequires -x all,allpy3,dev,google-onetap,saml,shopify
