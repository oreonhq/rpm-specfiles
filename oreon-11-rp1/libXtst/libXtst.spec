...
Source1:        https://src.fedoraproject.org/rpms/libXtst/raw/rawhide/f/make-git-snapshot.sh
Source2:        https://src.fedoraproject.org/rpms/libXtst/raw/rawhide/f/commitid
%else
Source0:        http://xorg.freedesktop.org/archive/individual/lib/%{name}-%{version}.tar.xz
%endif
