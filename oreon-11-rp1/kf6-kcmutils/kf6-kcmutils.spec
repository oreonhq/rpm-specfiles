...
%global source0_sha256 893346002b53a11bc9dd4053ad3d987d2545fac94fe38770f5d440343ee8e58a
%global source0_file kcmutils-6.24.0.tar.xz
...
%(f=%{_sourcedir}/kcmutils-6.24.0.tar.xz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "893346002b53a11bc9dd4053ad3d987d2545fac94fe38770f5d440343ee8e58a" || { echo "oreon: Source0 SHA256 mismatch for kcmutils-6.24.0.tar.xz" >&2; exit 1; })
