...
This is package 'kanboard' generated automatically by pyp2spec.}
...
%pyproject_extras_subpkg -n python3-kanboard dev


%prep
%autosetup -p1 -n kanboard-%{version}
