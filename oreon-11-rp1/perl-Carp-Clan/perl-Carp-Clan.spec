...
%global source0_sha256 c75f92e34422cc5a65ab05d155842b701452434e9aefb649d6e2289c47ef6708
%global source0_file Carp-Clan-6.08.tar.gz
...
%(f=%{_sourcedir}/Carp-Clan-6.08.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "c75f92e34422cc5a65ab05d155842b701452434e9aefb649d6e2289c47ef6708" || { echo "oreon: Source0 SHA256 mismatch for Carp-Clan-6.08.tar.gz" >&2; exit 1; })
