...
Source0:        https://download.kde.org/Attic/%{version}/src/%{name}/%{name}-ar-%{version}.tar.bz2
Source1:        https://download.kde.org/Attic/%{version}/src/%{name}/%{name}-bg-%{version}.tar.bz2
Source2:        https://download.kde.org/Attic/%{version}/src/%{name}/%{name}-bn-%{version}.tar.bz2
Source3:        https://download.kde.org/Attic/%{version}/src/%{name}/%{name}-ca-%{version}.tar.bz2
Source4:        https://download.kde.org/Attic/%{version}/src/%{name}/%{name}-cs-%{version}.tar.bz2
Source5:        https://download.kde.org/Attic/%{version}/src/%{name}/%{name}-da-%{version}.tar.bz2
Source6:        https://download.kde.org/Attic/%{version}/src/%{name}/%{name}-de-%{version}.tar.bz2
Source7:        https://download.kde.org/Attic/%{version}/src/%{name}/%{name}-el-%{version}.tar.bz2
Source8:        https://download.kde.org/Attic/%{version}/src/%{name}/%{name}-en_GB-%{version}.tar.bz2
Source9:        https://download.kde.org/Attic/%{version}/src/%{name}/%{name}-es-%{version}.tar.bz2
Source10:        https://download.kde.org/Attic/%{version}/src/%{name}/%{name}-et-%{version}.tar.bz2
Source11:        https://download.kde.org/Attic/%{version}/src/%{name}/%{name}-fi-%{version}.tar.bz2
Source12:        https://download.kde.org/Attic/%{version}/src/%{name}/%{name}-fr-%{version}.tar.bz2
Source13:        https://download.kde.org/Attic/%{version}/src/%{name}/%{name}-he-%{version}.tar.bz2
Source14:        https://download.kde.org/Attic/%{version}/src/%{name}/%{name}-hi-%{version}.tar.bz2
Source15:        https://download.kde.org/Attic/%{version}/src/%{name}/%{name}-hu-%{version}.tar.bz2
Source16:        https://download.kde.org/Attic/%{version}/src/%{name}/%{name}-is-%{version}.tar.bz2
Source17:        https://download.kde.org/Attic/%{version}/src/%{name}/%{name}-it-%{version}.tar.bz2
Source18:        https://download.kde.org/Attic/%{version}/src/%{name}/%{name}-ja-%{version}.tar.bz2
Source19:        https://download.kde.org/Attic/%{version}/src/%{name}/%{name}-nb-%{version}.tar.bz2
Source20:        https://download.kde.org/Attic/%{version}/src/%{name}/%{name}-nl-%{version}.tar.bz2
Source21:        https://download.kde.org/Attic/%{version}/src/%{name}/%{name}-nn-%{version}.tar.bz2
Source22:        https://download.kde.org/Attic/%{version}/src/%{name}/%{name}-pa-%{version}.tar.bz2
Source23:        https://download.kde.org/Attic/%{version}/src/%{name}/%{name}-pl-%{version}.tar.bz2
Source24:        https://download.kde.org/Attic/%{version}/src/%{name}/%{name}-pt-%{version}.tar.bz2
Source25:        https://download.kde.org/Attic/%{version}/src/%{name}/%{name}-pt_BR-%{version}.tar.bz2
Source26:        https://download.kde.org/Attic/%{version}/src/%{name}/%{name}-ro-%{version}.tar.bz2
Source27:        https://download.kde.org/Attic/%{version}/src/%{name}/%{name}-ru-%{version}.tar.bz2
Source28:        https://download.kde.org/Attic/%{version}/src/%{name}/%{name}-sk-%{version}.tar.bz2
Source29:        https://download.kde.org/Attic/%{version}/src/%{name}/%{name}-sl-%{version}.tar.bz2
Source30:        https://download.kde.org/Attic/%{version}/src/%{name}/%{name}-sr-%{version}.tar.bz2
Source31:        https://download.kde.org/Attic/%{version}/src/%{name}/%{name}-sv-%{version}.tar.bz2
Source32:        https://download.kde.org/Attic/%{version}/src/%{name}/%{name}-ta-%{version}.tar.bz2
Source33:        https://download.kde.org/Attic/%{version}/src/%{name}/%{name}-tr-%{version}.tar.bz2
Source34:        https://download.kde.org/Attic/%{version}/src/%{name}/%{name}-uk-%{version}.tar.bz2
Source35:        https://download.kde.org/Attic/%{version}/src/%{name}/%{name}-zh_CN-%{version}.tar.bz2
Source36:        https://download.kde.org/Attic/%{version}/src/%{name}/%{name}-zh_TW-%{version}.tar.bz2
Source37:        https://download.kde.org/Attic/%{version}/src/%{name}/%{name}-lt-%{version}.tar.bz2
Source38:        https://download.kde.org/Attic/%{version}/src/%{name}/%{name}-ko-%{version}.tar.bz2
