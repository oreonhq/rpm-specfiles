...
%global source0_sha256 070d94fe77969d8949bd129a618e6a7bee6b83b5b5db3ef3f983395a5428b914
%global source0_file commons-collections-3.2.2-src.tar.gz
...
%(f=%{_sourcedir}/commons-collections-3.2.2-src.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "070d94fe77969d8949bd129a618e6a7bee6b83b5b5db3ef3f983395a5428b914" || { echo "oreon: Source0 SHA256 mismatch for commons-collections-3.2.2-src.tar.gz" >&2; exit 1; })
