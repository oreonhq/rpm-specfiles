...
License:        Apache-2.0
URL:            https://coverage.readthedocs.io/en/7.16.1
Source:         %{pypi_source coverage}
...
This is package 'coverage' generated automatically by pyp2spec.}
...
%pyproject_extras_subpkg -n python3-coverage toml
