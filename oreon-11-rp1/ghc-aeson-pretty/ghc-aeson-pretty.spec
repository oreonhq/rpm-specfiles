...
%global source0_sha256 2a21f2cd78adcb149ceba770239ed664519552911e7680172b18ff695cfa7ae5
%global source0_file aeson-pretty-0.8.10.tar.gz
...
%(f=%{_sourcedir}/aeson-pretty-0.8.10.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "2a21f2cd78adcb149ceba770239ed664519552911e7680172b18ff695cfa7ae5" || { echo "oreon: Source0 SHA256 mismatch for aeson-pretty-0.8.10.tar.gz" >&2; exit 1; })
...
%changelog
* Tue Mar 17 2026 Oreon Packaging Team <packaging@oreonhq.com> - 0.8.10-1
