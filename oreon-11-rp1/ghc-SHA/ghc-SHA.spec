...
%global source0_file SHA-1.6.4.4.tar.gz
...
%(f=%{_sourcedir}/SHA-1.6.4.4.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "6bd950df6b11a3998bb1452d875d2da043ee43385459afc5f16d471d25178b44" || { echo "oreon: Source0 SHA256 mismatch for SHA-1.6.4.4.tar.gz" >&2; exit 1; })
