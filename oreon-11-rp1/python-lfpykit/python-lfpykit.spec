...
This is package 'lfpykit' generated automatically by pyp2spec.}
...
%pyproject_extras_subpkg -n python3-lfpykit docs,tests


%prep
%autosetup -p1 -n lfpykit-%{version}
