...
Source0:        https://repo1.maven.org/maven2/org/apache/maven/plugins/maven-remote-resources-plugin/3.1.0/maven-remote-resources-plugin-3.1.0-source-release.zip
