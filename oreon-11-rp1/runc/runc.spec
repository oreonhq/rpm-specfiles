...
%global source0_sha256 9e1dcd513e28fac99e7b47fec38ce4f1969a9a9693b80619e9009286e2d0d584
%global source0_file runc-1.4.2.tar.gz
...
%(f=%{_sourcedir}/runc-1.4.2.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "9e1dcd513e28fac99e7b47fec38ce4f1969a9a9693b80619e9009286e2d0d584" || { echo "oreon: Source0 SHA256 mismatch for runc-1.4.2.tar.gz" >&2; exit 1; })
