...
%global source0_sha256 5f2bdbad629707aa7d85c623f994aa8a1d2dec55a73de5205bac0bf6058a2f7c
%global source0_file acl-2.3.2.tar.gz
...
%(f=%{_sourcedir}/acl-2.3.2.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "5f2bdbad629707aa7d85c623f994aa8a1d2dec55a73de5205bac0bf6058a2f7c" || { echo "oreon: Source0 SHA256 mismatch for acl-2.3.2.tar.gz" >&2; exit 1; })
