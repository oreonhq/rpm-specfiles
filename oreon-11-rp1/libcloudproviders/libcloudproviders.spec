...
%global source0_sha256 3b75110b3a4fdef4c5c5a440e48701fe054d2ae061d156c89136bb5ba05e74b7
%global source0_file libcloudproviders-0.3.6.tar.xz
...
%(f=%{_sourcedir}/libcloudproviders-0.3.6.tar.xz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "3b75110b3a4fdef4c5c5a440e48701fe054d2ae061d156c89136bb5ba05e74b7" || { echo "oreon: Source0 SHA256 mismatch for libcloudproviders-0.3.6.tar.xz" >&2; exit 1; })
