...
# PimCommon::ConfigurePluginsWidget(QWidget *pluginList, QWidget *parent) takes QWidget*; do not cast to
# TextAddonsWidgets::ConfigurePluginsWidget* (older kpimcommon overloads are gone).
