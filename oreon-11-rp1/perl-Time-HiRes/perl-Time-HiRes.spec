...
%global source0_sha256 9841be5587bfb7cd1f2fe267b5e5ac04ce25e79d5cc77e5ef9a9c5abd101d7b1
%global source0_file Time-HiRes-1.9764.tar.gz
...
%(f=%{_sourcedir}/Time-HiRes-1.9764.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "9841be5587bfb7cd1f2fe267b5e5ac04ce25e79d5cc77e5ef9a9c5abd101d7b1" || { echo "oreon: Source0 SHA256 mismatch for Time-HiRes-1.9764.tar.gz" >&2; exit 1; })
