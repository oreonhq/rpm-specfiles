...
Source0:        https://download.kde.org/%{stable_kf6}/plasma/6.6.4/qqc2-breeze-style-6.6.4.tar.xz
Source1:        https://download.kde.org/%{stable_kf6}/plasma/6.6.4/qqc2-breeze-style-6.6.4.tar.xz.sig
