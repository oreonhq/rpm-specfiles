...
%global source0_sha256 89c5c6665337f56fd2db36bc3805a5619709d51fb136e51937072f63fcc717a7
%global source0_file cppunit-1.15.1.tar.gz
...
%(f=%{_sourcedir}/cppunit-1.15.1.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "89c5c6665337f56fd2db36bc3805a5619709d51fb136e51937072f63fcc717a7" || { echo "oreon: Source0 SHA256 mismatch for cppunit-1.15.1.tar.gz" >&2; exit 1; })
