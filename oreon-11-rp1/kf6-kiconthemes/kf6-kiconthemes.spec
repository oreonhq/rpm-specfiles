...
%global source0_sha256 5fee1141ac94693b94b6f80e52eb26ed99c81816c64eb520abffa0e1e7ed5956
%global source0_file kiconthemes-6.24.0.tar.xz
...
%(f=%{_sourcedir}/kiconthemes-6.24.0.tar.xz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "5fee1141ac94693b94b6f80e52eb26ed99c81816c64eb520abffa0e1e7ed5956" || { echo "oreon: Source0 SHA256 mismatch for kiconthemes-6.24.0.tar.xz" >&2; exit 1; })
