%global source0_hash eddd3ca559203180a307f12d114c268abf583f59b03cb906fd0b3ff8646c1147
...
%package     -n %{name}+macos-system-configuration-devel
Summary:        %{summary}
BuildArch:      noarch

%description -n %{name}+macos-system-configuration-devel %{_description}
