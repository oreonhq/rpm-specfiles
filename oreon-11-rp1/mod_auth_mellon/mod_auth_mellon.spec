...
%global source0_sha256 906919082a79ae6a747f8072158df417c8ba5ba9c97f3e0f77f5f95346d8c3e0
%global source0_file mod_auth_mellon-0.19.1.tar.gz
...
%(f=%{_sourcedir}/mod_auth_mellon-0.19.1.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "906919082a79ae6a747f8072158df417c8ba5ba9c97f3e0f77f5f95346d8c3e0" || { echo "oreon: Source0 SHA256 mismatch for mod_auth_mellon-0.19.1.tar.gz" >&2; exit 1; })
...
%changelog
* Tue Mar 17 2026 Oreon Packaging Team <packaging@oreonhq.com> - 0.19.1-2
