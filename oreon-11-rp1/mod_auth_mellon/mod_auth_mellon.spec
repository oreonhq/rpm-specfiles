%global source0_hash 906919082a79ae6a747f8072158df417c8ba5ba9c97f3e0f77f5f95346d8c3e0
...
Version: 0.19.1
Release: 2%{?dist}
Source0:        https://github.com/latchset/mod_auth_mellon/archive/refs/tags/v%{version}.tar.gz#/%{name}-%{version}.tar.gz
