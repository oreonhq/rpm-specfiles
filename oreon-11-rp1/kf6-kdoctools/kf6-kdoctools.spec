...
%global source0_sha256 aee351c52f783813c6c114ade520c8578c570ee6dc25ecbd64c83e3d2d9660d4
%global source0_file kdoctools-6.24.0.tar.xz
...
%(f=%{_sourcedir}/kdoctools-6.24.0.tar.xz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "aee351c52f783813c6c114ade520c8578c570ee6dc25ecbd64c83e3d2d9660d4" || { echo "oreon: Source0 SHA256 mismatch for kdoctools-6.24.0.tar.xz" >&2; exit 1; })
