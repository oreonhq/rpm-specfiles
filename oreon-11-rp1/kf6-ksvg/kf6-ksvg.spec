...
%global source0_sha256 c4d61f6bb4c61452e83de0427f444cdec296d87333f6c7676fb7dae09480f4d2
%global source0_file ksvg-6.24.0.tar.xz
...
%(f=%{_sourcedir}/ksvg-6.24.0.tar.xz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "c4d61f6bb4c61452e83de0427f444cdec296d87333f6c7676fb7dae09480f4d2" || { echo "oreon: Source0 SHA256 mismatch for ksvg-6.24.0.tar.xz" >&2; exit 1; })
