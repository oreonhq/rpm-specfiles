...
%global source0_sha256 967282d54d2d51b198c67935594f93e4dea3e54d1e5bced158c94e29be868a4b
%global source0_file Sub-Quote-2.006009.tar.gz
...
%(f=%{_sourcedir}/Sub-Quote-2.006009.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "967282d54d2d51b198c67935594f93e4dea3e54d1e5bced158c94e29be868a4b" || { echo "oreon: Source0 SHA256 mismatch for Sub-Quote-2.006009.tar.gz" >&2; exit 1; })
