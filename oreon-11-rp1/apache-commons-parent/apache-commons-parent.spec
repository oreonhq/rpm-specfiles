...
%global source0_file commons-parent-89.tar.gz
...
%(f=%{_sourcedir}/commons-parent-89.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "18ea71fef1ecef690c9d86f4ffdfd83ee68a6ff41b6bc7e7b7a6be0b8f5ae000" || { echo "oreon: Source0 SHA256 mismatch for commons-parent-89.tar.gz" >&2; exit 1; })
