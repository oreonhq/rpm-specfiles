...
%global source0_sha256 7331c7c84886c53337c0db823615e0e7134a8f13efd284e5c20726d5bcd52dff
%global source0_file Data-ICal-0.24.tar.gz
...
%(f=%{_sourcedir}/Data-ICal-0.24.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "7331c7c84886c53337c0db823615e0e7134a8f13efd284e5c20726d5bcd52dff" || { echo "oreon: Source0 SHA256 mismatch for Data-ICal-0.24.tar.gz" >&2; exit 1; })
