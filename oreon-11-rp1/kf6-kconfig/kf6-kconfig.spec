...
%global source0_sha256 45cfbdd8419bd1ade54a6f54050f2465de76a4f91b7a702b806930e6fbb3651f
%global source0_file kconfig-6.24.0.tar.xz
...
%(f=%{_sourcedir}/kconfig-6.24.0.tar.xz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "45cfbdd8419bd1ade54a6f54050f2465de76a4f91b7a702b806930e6fbb3651f" || { echo "oreon: Source0 SHA256 mismatch for kconfig-6.24.0.tar.xz" >&2; exit 1; })
