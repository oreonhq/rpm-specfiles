...
Source0:        https://download.kde.org/%{stable_kf6}/frameworks/%{majmin_ver_kf6}/kcontacts-6.26.0.tar.xz
Source1:        https://download.kde.org/%{stable_kf6}/frameworks/%{majmin_ver_kf6}/kcontacts-6.26.0.tar.xz.sig
