...
%global source0_file prison-6.24.0.tar.xz
...
%(f=%{_sourcedir}/prison-6.24.0.tar.xz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "39ea2b51fd0e405b964c1f22d64ad0111c79895894590d68b29712d7dde4cd34" || { echo "oreon: Source0 SHA256 mismatch for prison-6.24.0.tar.xz" >&2; exit 1; })
