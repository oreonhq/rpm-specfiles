...
Source0:        https://github.com/java-schema-utilities/%{name}/archive/refs/tags/relaxngDatatype-%{version}.tar.gz#/relaxng-datatype-java-2011.1.tar.gz
Source1:        copying.txt
...
%setup -q -n relaxng-datatype-java-relaxngDatatype-2011.1
%autosetup -p1 -n relaxng-datatype-java-relaxngDatatype-2011.1
cp %{SOURCE1} .
