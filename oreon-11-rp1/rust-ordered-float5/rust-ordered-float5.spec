%global source0_hash b7d950ca161dc355eaf28f82b11345ed76c6e1f6eb1f4f4479e0323b9e2fbd0e
...
%package     -n %{name}+derive-visitor-devel
Summary:        %{summary}
BuildArch:      noarch

%description -n %{name}+derive-visitor-devel %{_description}

This package contains library source intended for building other packages which
use the "derive-visitor" feature of the "%{crate}" crate.

%files       -n %{name}+derive-visitor-devel
%ghost %{crate_instdir}/Cargo.toml
...
%package     -n %{name}+num-cmp-devel
Summary:        %{summary}
BuildArch:      noarch

%description -n %{name}+num-cmp-devel %{_description}

This package contains library source intended for building other packages which
use the "num-cmp" feature of the "%{crate}" crate.

%files       -n %{name}+num-cmp-devel
%ghost %{crate_instdir}/Cargo.toml
