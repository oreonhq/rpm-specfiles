...
%global source0_sha256 9dc5d1f495e951b5402713cc61b01617f586fdc39dbda3ef7e12e661a9b5af0a
%global source0_file kglobalaccel-6.24.0.tar.xz
...
%(f=%{_sourcedir}/kglobalaccel-6.24.0.tar.xz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "9dc5d1f495e951b5402713cc61b01617f586fdc39dbda3ef7e12e661a9b5af0a" || { echo "oreon: Source0 SHA256 mismatch for kglobalaccel-6.24.0.tar.xz" >&2; exit 1; })
