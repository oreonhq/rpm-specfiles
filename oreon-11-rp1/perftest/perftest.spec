%global source0_hash 750bc48b1d9362996de1d2bbe36d3b25f067b5077177d39c2faeb472bd5a7194
...
%prep
test "%{source0_hash}" = "none" || { f="%{SOURCE0}"; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "%{source0_hash}" || { echo "oreon: Source0 hash mismatch" >&2; exit 1; }; }# The directory in the tarball has only the part before the dash.
