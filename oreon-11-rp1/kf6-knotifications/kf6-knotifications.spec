...
%global source0_sha256 12bb0b34ac9ae39b96d189cc0b29f526ae12a9014d0aad3721cacc9148e42940
%global source0_file knotifications-6.24.0.tar.xz
...
%(f=%{_sourcedir}/knotifications-6.24.0.tar.xz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "12bb0b34ac9ae39b96d189cc0b29f526ae12a9014d0aad3721cacc9148e42940" || { echo "oreon: Source0 SHA256 mismatch for knotifications-6.24.0.tar.xz" >&2; exit 1; })
