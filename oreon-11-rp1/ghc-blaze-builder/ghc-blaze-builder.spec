...
%global source0_sha256 971d360428ac97af9a4e55e4f2c23649f6cedc0ce5d6e94d520e663f33ea5113
%global source0_file blaze-builder-0.4.4.1.tar.gz
...
%(f=%{_sourcedir}/blaze-builder-0.4.4.1.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "971d360428ac97af9a4e55e4f2c23649f6cedc0ce5d6e94d520e663f33ea5113" || { echo "oreon: Source0 SHA256 mismatch for blaze-builder-0.4.4.1.tar.gz" >&2; exit 1; })
...
%changelog
* Tue Mar 17 2026 Oreon Packaging Team <packaging@oreonhq.com> - 0.4.4.1-1
