...
%global source0_sha256 34bd82d47e981940751619c9cc44c095bb90bfcaf8d71865cbb822c37690a764
%global source0_file plugins-1.9.1.tar.gz
...
%(f=%{_sourcedir}/plugins-1.9.1.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "34bd82d47e981940751619c9cc44c095bb90bfcaf8d71865cbb822c37690a764" || { echo "oreon: Source0 SHA256 mismatch for plugins-1.9.1.tar.gz" >&2; exit 1; })
