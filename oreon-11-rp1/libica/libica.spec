%global source0_hash edc755494797331427c5f7900c7eecd8b5ecd3e69b7502313bf764f490b8e87a
...
Source0:        https://github.com/opencryptoki/%{name}/archive/v%{version}/%{name}-%{version}.tar.gz#/libica-4.4.1.tar.gz
