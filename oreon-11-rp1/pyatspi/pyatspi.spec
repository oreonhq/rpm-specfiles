...
Source0: https://download.gnome.org/sources/pyatspi/%{major_minor_version}/pyatspi-%{version}.tar.xz
BuildRequires:  gcc
BuildRequires:  meson
...
%changelog
* Mon May 25 2026 Oreon Packaging Team <packaging@oreonhq.com> - 2.58.2-1
- Import
