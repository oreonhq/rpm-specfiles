...
%global source0_sha256 ed0b7c10ce92c9ffe45420dadc38c6d39db486ff3633ff13567cc9f75f79b112
%global source0_file hashable-1.5.1.0.tar.gz
...
%(f=%{_sourcedir}/hashable-1.5.1.0.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "ed0b7c10ce92c9ffe45420dadc38c6d39db486ff3633ff13567cc9f75f79b112" || { echo "oreon: Source0 SHA256 mismatch for hashable-1.5.1.0.tar.gz" >&2; exit 1; })
