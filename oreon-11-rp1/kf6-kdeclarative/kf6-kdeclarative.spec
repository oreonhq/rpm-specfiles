...
%global source0_sha256 d00d697aa8ce7a5a16864e92bc74f52adb2b3008881d6e12b66155a80b136915
%global source0_file kdeclarative-6.24.0.tar.xz
...
%(f=%{_sourcedir}/kdeclarative-6.24.0.tar.xz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "d00d697aa8ce7a5a16864e92bc74f52adb2b3008881d6e12b66155a80b136915" || { echo "oreon: Source0 SHA256 mismatch for kdeclarative-6.24.0.tar.xz" >&2; exit 1; })
