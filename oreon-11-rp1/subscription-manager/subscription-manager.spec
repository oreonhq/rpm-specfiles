...
Source0:        https://github.com/candlepin/subscription-manager/archive/refs/tags/subscription-manager-%{version}-1.tar.gz#/%{name}-%{version}.tar.gz
...
%setup -q -n subscription-manager-subscription-manager-%{version}-1
