...
%global source0_sha256 63f95798d80b81ea8cea4848f342f26593c60f152dbd04d8981c846f979e6835
%global source0_file File-DesktopEntry-0.23.tar.gz
...
%(f=%{_sourcedir}/File-DesktopEntry-0.23.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "63f95798d80b81ea8cea4848f342f26593c60f152dbd04d8981c846f979e6835" || { echo "oreon: Source0 SHA256 mismatch for File-DesktopEntry-0.23.tar.gz" >&2; exit 1; })
