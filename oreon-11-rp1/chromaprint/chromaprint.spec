...
%global source0_file chromaprint-1.6.0.tar.gz
...
%(f=%{_sourcedir}/chromaprint-1.6.0.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "9d33482e56a1389a37a0d6742c376139fa43e3b8a63d29003222b93db2cb40da" || { echo "oreon: Source0 SHA256 mismatch for chromaprint-1.6.0.tar.gz" >&2; exit 1; })
