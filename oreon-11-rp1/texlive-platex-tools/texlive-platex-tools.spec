...
BuildArch:      noarch
Source0:        https://ctan.math.illinois.edu/systems/texlive/tlnet/archive/platex-tools.tar.xz#/platex-tools.or11.tar.xz
Source1:        https://ctan.math.illinois.edu/systems/texlive/tlnet/archive/platex-tools.doc.tar.xz#/platex-tools.doc.or11.tar.xz
BuildRequires:  tar
