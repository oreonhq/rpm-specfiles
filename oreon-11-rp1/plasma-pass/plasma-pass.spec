...
%global source0_sha256 91b32509638ab602073816287110ac79b86ffc7f05c23b3285886f7ce6e4cd0f
%global source0_file plasma-pass-1.3.0.tar.xz
...
%(f=%{_sourcedir}/plasma-pass-1.3.0.tar.xz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "91b32509638ab602073816287110ac79b86ffc7f05c23b3285886f7ce6e4cd0f" || { echo "oreon: Source0 SHA256 mismatch for plasma-pass-1.3.0.tar.xz" >&2; exit 1; })
