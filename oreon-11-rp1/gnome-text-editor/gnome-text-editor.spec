...
Source0:        https://download.gnome.org/sources/gnome-text-editor/50/gnome-text-editor-%(echo.tar.xz
...
%changelog
* Mon May 25 2026 Oreon Packaging Team <packaging@oreonhq.com> - 50.1-1
- Import
