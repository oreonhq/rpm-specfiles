...
%global source0_sha256 e606365038ce20d646d255c805effdd32f86475f18d43ca75455b00e4d86dd35
%global source0_file String-ShellQuote-1.04.tar.gz
...
%(f=%{_sourcedir}/String-ShellQuote-1.04.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "e606365038ce20d646d255c805effdd32f86475f18d43ca75455b00e4d86dd35" || { echo "oreon: Source0 SHA256 mismatch for String-ShellQuote-1.04.tar.gz" >&2; exit 1; })
