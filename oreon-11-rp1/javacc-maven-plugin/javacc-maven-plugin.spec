...
%global source0_sha256 6b7632943f6f1936f06e5f6e53dda652de0932a19d8f1ddc27135788d9736145
%global source0_file javacc-maven-plugin-3.2.0.tar.gz
...
%(f=%{_sourcedir}/javacc-maven-plugin-3.2.0.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "6b7632943f6f1936f06e5f6e53dda652de0932a19d8f1ddc27135788d9736145" || { echo "oreon: Source0 SHA256 mismatch for javacc-maven-plugin-3.2.0.tar.gz" >&2; exit 1; })
