...
%global source0_sha256 45967a1b596f1dfd21371948275a330ab3ede6fd94fdfd22f6ae5eb0b122de64
%global source0_file qqc2-desktop-style-6.24.0.tar.xz
...
%(f=%{_sourcedir}/qqc2-desktop-style-6.24.0.tar.xz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "45967a1b596f1dfd21371948275a330ab3ede6fd94fdfd22f6ae5eb0b122de64" || { echo "oreon: Source0 SHA256 mismatch for qqc2-desktop-style-6.24.0.tar.xz" >&2; exit 1; })
