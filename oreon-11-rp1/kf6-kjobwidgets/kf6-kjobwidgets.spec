...
%global source0_sha256 b3c5f449bf29b98394157656600e87b91f769afc5f547cef526faddb454f9b61
%global source0_file kjobwidgets-6.24.0.tar.xz
...
%(f=%{_sourcedir}/kjobwidgets-6.24.0.tar.xz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "b3c5f449bf29b98394157656600e87b91f769afc5f547cef526faddb454f9b61" || { echo "oreon: Source0 SHA256 mismatch for kjobwidgets-6.24.0.tar.xz" >&2; exit 1; })
