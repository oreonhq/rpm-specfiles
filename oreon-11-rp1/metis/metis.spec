...
Source0:        https://github.com/scivision/METIS/archive/refs/tags/v%{version}.tar.gz#/METIS-%{version}.tar.gz
...
%changelog
* Tue Mar 17 2026 Oreon Packaging Team <packaging@oreonhq.com> - 5.1.0.3-1
