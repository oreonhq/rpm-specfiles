...
%global source0_sha256 65542ef39f7644a3d76afcadeb976d3e334c6947516b7313fcb59165cea1608f
%global source0_file blaze-html-0.9.2.0.tar.gz
...
%(f=%{_sourcedir}/blaze-html-0.9.2.0.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "65542ef39f7644a3d76afcadeb976d3e334c6947516b7313fcb59165cea1608f" || { echo "oreon: Source0 SHA256 mismatch for blaze-html-0.9.2.0.tar.gz" >&2; exit 1; })
...
%changelog
* Tue Mar 17 2026 Oreon Packaging Team <packaging@oreonhq.com> - 0.9.2.0-1
