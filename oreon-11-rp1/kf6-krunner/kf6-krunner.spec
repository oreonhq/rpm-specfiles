...
%global source0_file krunner-6.24.0.tar.xz
...
%(f=%{_sourcedir}/krunner-6.24.0.tar.xz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "5775d7292a31c0ca339b385c18f3716fda5486317423c53809a10d8008ff8e4d" || { echo "oreon: Source0 SHA256 mismatch for krunner-6.24.0.tar.xz" >&2; exit 1; })
