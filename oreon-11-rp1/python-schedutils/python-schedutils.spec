...
%global source0_file python-schedutils-0.6.tar.xz
...
%(f=%{_sourcedir}/python-schedutils-0.6.tar.xz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "90a24f8d46574513b3d334b473e128c456e7eddaec6e3dd198d7e5ad69ddc12f" || { echo "oreon: Source0 SHA256 mismatch for python-schedutils-0.6.tar.xz" >&2; exit 1; })
