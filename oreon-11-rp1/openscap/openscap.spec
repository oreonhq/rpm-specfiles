...
%global source0_sha256 96ebe697aafc83eb297a8f29596d57319278112467c46e6aaf3649b311cf8fba
%global source0_file openscap-1.4.3.tar.gz
...
%(f=%{_sourcedir}/openscap-1.4.3.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "96ebe697aafc83eb297a8f29596d57319278112467c46e6aaf3649b311cf8fba" || { echo "oreon: Source0 SHA256 mismatch for openscap-1.4.3.tar.gz" >&2; exit 1; })
