...
%global source0_file File-CheckTree-4.42.tar.gz
...
%(f=%{_sourcedir}/File-CheckTree-4.42.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "66fb417f8ff8a5e5b7ea25606156e70e204861c59fa8c3831925b4dd3f155f8a" || { echo "oreon: Source0 SHA256 mismatch for File-CheckTree-4.42.tar.gz" >&2; exit 1; })
