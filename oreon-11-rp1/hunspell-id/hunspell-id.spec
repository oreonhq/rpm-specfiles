...
URL: https://cgit.freedesktop.org/libreoffice/dictionaries/tree/id
...
install -pm 0644 dictionaries/id/id_ID.aff %{buildroot}%{_datadir}/%{dict_dirname}/
install -pm 0644 dictionaries/id/id_ID.dic %{buildroot}%{_datadir}/%{dict_dirname}/


%files
%doc dictionaries/id/README-dict.adoc
