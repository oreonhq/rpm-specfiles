...
%global source0_sha256 6ae9898afe788a5e334cd5fad5d18a3c2e8e59fa09aaf7b957dbb38a4767df2e
%global source0_file clock-0.8.4.tar.gz
...
%(f=%{_sourcedir}/clock-0.8.4.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "6ae9898afe788a5e334cd5fad5d18a3c2e8e59fa09aaf7b957dbb38a4767df2e" || { echo "oreon: Source0 SHA256 mismatch for clock-0.8.4.tar.gz" >&2; exit 1; })
