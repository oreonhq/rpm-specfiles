...
%global source0_sha256 f0c9d33876c36b1bca1475276d26d2efaf449b256d7cc8118fae012e89a26290
%global source0_file Params-Check-0.38.tar.gz
...
%(f=%{_sourcedir}/Params-Check-0.38.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "f0c9d33876c36b1bca1475276d26d2efaf449b256d7cc8118fae012e89a26290" || { echo "oreon: Source0 SHA256 mismatch for Params-Check-0.38.tar.gz" >&2; exit 1; })
