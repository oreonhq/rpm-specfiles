...
%global source0_sha256 5843f79b96c12d9e4ea57dc9902456d9fd6d52c509bee38a0a6a5323c8f04db3
%global source0_file tls-2.1.8.tar.gz
...
%(f=%{_sourcedir}/tls-2.1.8.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "5843f79b96c12d9e4ea57dc9902456d9fd6d52c509bee38a0a6a5323c8f04db3" || { echo "oreon: Source0 SHA256 mismatch for tls-2.1.8.tar.gz" >&2; exit 1; })
...
%changelog
* Tue Mar 17 2026 Oreon Packaging Team <packaging@oreonhq.com> - 2.1.8-1
