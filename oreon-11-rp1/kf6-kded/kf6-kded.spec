...
%global source0_sha256 f60981d4000961425cbeabe90f0f77e9792cbd5421e55b4c224fdb14aa96b2a5
%global source0_file kded-6.24.0.tar.xz
...
%(f=%{_sourcedir}/kded-6.24.0.tar.xz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "f60981d4000961425cbeabe90f0f77e9792cbd5421e55b4c224fdb14aa96b2a5" || { echo "oreon: Source0 SHA256 mismatch for kded-6.24.0.tar.xz" >&2; exit 1; })
