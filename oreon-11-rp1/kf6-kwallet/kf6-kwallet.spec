...
%global source0_sha256 094a26ec24a2fc9ae73096c47da2d963799668ef9e0e4004162a0082e54f9520
%global source0_file kwallet-6.24.0.tar.xz
...
%(f=%{_sourcedir}/kwallet-6.24.0.tar.xz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "094a26ec24a2fc9ae73096c47da2d963799668ef9e0e4004162a0082e54f9520" || { echo "oreon: Source0 SHA256 mismatch for kwallet-6.24.0.tar.xz" >&2; exit 1; })
