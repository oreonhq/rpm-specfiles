...
%global source1_hash 3364bc17e204d5e1ca5765ad1de9d9899e30215b243c8e03eee53888b9b525d1
...
test "%{source1_hash}" = "none" || { f="%{SOURCE1}"; test -f "$f" || { echo "oreon: missing Source1 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "%{source1_hash}" || { echo "oreon: Source1 hash mismatch" >&2; exit 1; }; }tar xf %{SOURCE3}
