...
Source0:        https://github.com/git-lfs/git-lfs/releases/download/v3.7.1/git-lfs-v3.7.1.tar.gz
# Generated by go-vendor-tools
Source1:        %{name}-%{version}-vendor.tar.bz2
Source2:        https://github.com/git-lfs/git-lfs/releases/download/v3.7.1/sha256sums.asc#/sha256sums-3.7.1.asc
