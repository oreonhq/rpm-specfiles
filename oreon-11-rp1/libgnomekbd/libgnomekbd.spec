...
%global source0_file libgnomekbd-3.28.1.tar.xz
...
%(f=%{_sourcedir}/libgnomekbd-3.28.1.tar.xz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "22dc59566d73c0065350f5a97340e62ecc7b08c4df19183804bb8be24c8fe870" || { echo "oreon: Source0 SHA256 mismatch for libgnomekbd-3.28.1.tar.xz" >&2; exit 1; })
