...
%global source0_sha256 d488089a64ee4060bce7dbba0291fcca358e7f7ac5230e2ee5b344e7485729c4
%global source0_file postgis-3.6.2.tar.gz
...
%(f=%{_sourcedir}/postgis-3.6.2.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "d488089a64ee4060bce7dbba0291fcca358e7f7ac5230e2ee5b344e7485729c4" || { echo "oreon: Source0 SHA256 mismatch for postgis-3.6.2.tar.gz" >&2; exit 1; })
