...
%global source0_sha256 be5add002c4f3d96c2632ecebbf5633d9792f9d13d61a91a6a2c349540a807d3
%global source0_file kdesu-6.24.0.tar.xz
...
%(f=%{_sourcedir}/kdesu-6.24.0.tar.xz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "be5add002c4f3d96c2632ecebbf5633d9792f9d13d61a91a6a2c349540a807d3" || { echo "oreon: Source0 SHA256 mismatch for kdesu-6.24.0.tar.xz" >&2; exit 1; })
