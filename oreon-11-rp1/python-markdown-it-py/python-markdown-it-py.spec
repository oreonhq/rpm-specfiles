...
%pyproject_extras_subpkg -n python3-markdown-it-py benchmarking,compare,linkify,plugins,profiling,rtd,testing
...
%pyproject_buildrequires -x benchmarking,compare,linkify,plugins,profiling,rtd,testing
