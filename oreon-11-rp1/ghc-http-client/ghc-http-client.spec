...
%global source0_sha256 a02c1be082e8f48c959ac7150a48a405f8d4383e0942639481e84b220f29ad61
%global source0_file http-client-0.7.19.tar.gz
...
%(f=%{_sourcedir}/http-client-0.7.19.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "a02c1be082e8f48c959ac7150a48a405f8d4383e0942639481e84b220f29ad61" || { echo "oreon: Source0 SHA256 mismatch for http-client-0.7.19.tar.gz" >&2; exit 1; })
...
%changelog
* Tue Mar 17 2026 Oreon Packaging Team <packaging@oreonhq.com> - 0.7.19-1
