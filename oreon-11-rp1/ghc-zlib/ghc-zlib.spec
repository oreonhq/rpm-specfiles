...
%global source0_sha256 bf95ab01ed924be800addea195fba5ca97ec69f378368f6ff466bdc29666c1c1
%global source0_file zlib-0.7.1.1.tar.gz
...
%(f=%{_sourcedir}/zlib-0.7.1.1.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "bf95ab01ed924be800addea195fba5ca97ec69f378368f6ff466bdc29666c1c1" || { echo "oreon: Source0 SHA256 mismatch for zlib-0.7.1.1.tar.gz" >&2; exit 1; })
...
%changelog
* Tue Mar 17 2026 Oreon Packaging Team <packaging@oreonhq.com> - 0.7.1.1-1
