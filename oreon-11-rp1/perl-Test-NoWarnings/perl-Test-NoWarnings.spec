...
%global source0_file Test-NoWarnings-1.06.tar.gz
...
%(f=%{_sourcedir}/Test-NoWarnings-1.06.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "c2dc51143b7eb63231210e27df20d2c8393772e0a333547ec8b7a205ed62f737" || { echo "oreon: Source0 SHA256 mismatch for Test-NoWarnings-1.06.tar.gz" >&2; exit 1; })
