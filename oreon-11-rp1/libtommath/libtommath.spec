...
%global source0_sha256 0e9247ab1c4e64110024e34082ce8401f089f7df8e40de0b1ce6a03641302d56
%global source0_file v1.3.1-rc1.tar.gz
...
%(f=%{_sourcedir}/v1.3.1-rc1.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "0e9247ab1c4e64110024e34082ce8401f089f7df8e40de0b1ce6a03641302d56" || { echo "oreon: Source0 SHA256 mismatch for v1.3.1-rc1.tar.gz" >&2; exit 1; })
