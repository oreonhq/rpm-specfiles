...
%global source4_hash c8770fba789ce80334cae628285103c49abec0fa074773cbb5a88e26f5a7725d
...
test "%{source4_hash}" = "none" || { f="%{SOURCE4}"; test -f "$f" || { echo "oreon: missing Source4 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "%{source4_hash}" || { echo "oreon: Source4 hash mismatch" >&2; exit 1; }; }# Begin cabal-rpm setup:
