...
%global source0_sha256 ce5cd44d4ffeafdcc3dddaa072b2179c0b7cb1abf4e6c5d18d4375f8a39fe491
%global source0_file gstreamer-1.28.2.tar.xz
...
%(f=%{_sourcedir}/gstreamer-1.28.2.tar.xz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "ce5cd44d4ffeafdcc3dddaa072b2179c0b7cb1abf4e6c5d18d4375f8a39fe491" || { echo "oreon: Source0 SHA256 mismatch for gstreamer-1.28.2.tar.xz" >&2; exit 1; })
