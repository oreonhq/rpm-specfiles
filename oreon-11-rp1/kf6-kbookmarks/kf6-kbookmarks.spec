...
%global source0_sha256 e2ada057c77f5939e7172d0c3acd8c85273b0823b28697c89cbc2cce23d68d5d
%global source0_file kbookmarks-6.24.0.tar.xz
...
%(f=%{_sourcedir}/kbookmarks-6.24.0.tar.xz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "e2ada057c77f5939e7172d0c3acd8c85273b0823b28697c89cbc2cce23d68d5d" || { echo "oreon: Source0 SHA256 mismatch for kbookmarks-6.24.0.tar.xz" >&2; exit 1; })
