...
%global source0_sha256 7424b61c152764c84d4dbba51ad960a9d7894e6909ecfaaa13e7b129585c0b57
%global source0_file ki18n-6.24.0.tar.xz
...
%(f=%{_sourcedir}/ki18n-6.24.0.tar.xz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "7424b61c152764c84d4dbba51ad960a9d7894e6909ecfaaa13e7b129585c0b57" || { echo "oreon: Source0 SHA256 mismatch for ki18n-6.24.0.tar.xz" >&2; exit 1; })
