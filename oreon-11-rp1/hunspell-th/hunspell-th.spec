...
URL: https://cgit.freedesktop.org/libreoffice/dictionaries/tree/th_TH
...
install -pm 0644 dictionaries/th_TH/th_TH.aff %{buildroot}%{_datadir}/%{dict_dirname}/
install -pm 0644 dictionaries/th_TH/th_TH.dic %{buildroot}%{_datadir}/%{dict_dirname}/


%files
%doc dictionaries/th_TH/README_th_TH.txt
