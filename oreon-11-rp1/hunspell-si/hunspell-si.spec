...
install -pm 0644 dictionaries/si_LK/si_LK.aff %{buildroot}%{_datadir}/%{dict_dirname}/
install -pm 0644 dictionaries/si_LK/si_LK.dic %{buildroot}%{_datadir}/%{dict_dirname}/
