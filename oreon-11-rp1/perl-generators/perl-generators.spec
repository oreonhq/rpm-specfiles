...
%global source0_sha256 36cf8c16ec969826217ff7458535a29714cb471dadba1672a303034d029a6e64
%global source0_file generators-1.16.tar.gz
...
%(f=%{_sourcedir}/generators-1.16.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "36cf8c16ec969826217ff7458535a29714cb471dadba1672a303034d029a6e64" || { echo "oreon: Source0 SHA256 mismatch for generators-1.16.tar.gz" >&2; exit 1; })
