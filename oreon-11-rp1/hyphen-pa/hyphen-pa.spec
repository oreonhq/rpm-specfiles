...
%global source0_sha256 1c6a08f4458e2b3b4bbe4118ad3af238942dcfc3f5f63a8828cad76889e9c57d
%global source0_file hyphen-pa-0.7.0.tar.bz2
...
%(f=%{_sourcedir}/hyphen-pa-0.7.0.tar.bz2; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "1c6a08f4458e2b3b4bbe4118ad3af238942dcfc3f5f63a8828cad76889e9c57d" || { echo "oreon: Source0 SHA256 mismatch for hyphen-pa-0.7.0.tar.bz2" >&2; exit 1; })
