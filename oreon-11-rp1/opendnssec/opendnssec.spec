...
Source0:        https://dist.opendnssec.org/source/%{?prever:testing/}opendnssec-2.1.14%{?prever}.tar.gz
Source10:        https://dist.opendnssec.org/source/%{?prever:testing/}opendnssec-2.1.14%{?prever}.tar.gz.sig
