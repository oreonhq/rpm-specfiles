...
%global source0_sha256 aaf473e80021c63e06df6ee200a61e71296665c770a5046ef297d2082fa77d65
%global source0_file frameworkintegration-6.24.0.tar.xz
...
%(f=%{_sourcedir}/frameworkintegration-6.24.0.tar.xz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "aaf473e80021c63e06df6ee200a61e71296665c770a5046ef297d2082fa77d65" || { echo "oreon: Source0 SHA256 mismatch for frameworkintegration-6.24.0.tar.xz" >&2; exit 1; })
