...
%global source0_sha256 708a60513d6da61e09b60b9a486106af703a889b5b43472a27c3b60bf35246ab
%global source0_file unordered-containers-0.2.20.1.tar.gz
...
%(f=%{_sourcedir}/unordered-containers-0.2.20.1.tar.gz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "708a60513d6da61e09b60b9a486106af703a889b5b43472a27c3b60bf35246ab" || { echo "oreon: Source0 SHA256 mismatch for unordered-containers-0.2.20.1.tar.gz" >&2; exit 1; })
...
%changelog
* Tue Mar 17 2026 Oreon Packaging Team <packaging@oreonhq.com> - 0.2.20.1-1
