%global source0_hash 4d0fef132ad0d8beeede62d9f5b45ffdf5f85bf34bd63c26f5709b9882844ddd
...
for i in 16 22 24 32 36 48 64 72 96 128 256 ; do
  ...
  magick convert -geometry ${i} %{SOURCE2} %{buildroot}%{_datadir}/icons/hicolor/${i}x${i}/apps/%{name}.png
done
