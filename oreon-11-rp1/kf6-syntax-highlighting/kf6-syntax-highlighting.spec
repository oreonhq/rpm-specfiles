...
%global source0_sha256 061c5946dc6170ecfa91b9c7d4faa5ec81eb53bb5f86eda861c2ce748a65486d
%global source0_file syntax-highlighting-6.24.0.tar.xz
...
%(f=%{_sourcedir}/syntax-highlighting-6.24.0.tar.xz; test -f "$f" || { echo "oreon: missing Source0 $f" >&2; exit 1; }; h=$(sha256sum "$f" | awk '{print $1}'); test "$h" = "061c5946dc6170ecfa91b9c7d4faa5ec81eb53bb5f86eda861c2ce748a65486d" || { echo "oreon: Source0 SHA256 mismatch for syntax-highlighting-6.24.0.tar.xz" >&2; exit 1; })
